...
if ! sure; then
    ...
    TIMEFORMAT='Generated file in: %E'
    time {
...
TIMEFORMAT='Time taken for dd and sync: %E'
time {
...
TIMEFORMAT='Time taken to clear SD card: %E'
time {
...
TIMEFORMAT='Time taken for sdupdate and sync: %E'
time {
